...
Вираз ініціалізації виконується лише раз, перед початком циклу, та часто використовується для визначення та налаштування змінної циклу. Think of it like declaring a counter to use in your loop.
